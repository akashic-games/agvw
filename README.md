...
`engine_configuration_version` と `engine_urls` は、実行環境が提供するエンジンのランタイム (akashic-runtime) のバージョンと URL である必要があります。

> [!NOTE]
> ランタイムの具体的なファイルは、[akashic-runtime-distributables][dists] リポジトリの [Releases][dists-rel] ページで dist.zip としてまとめて配布されています。
> dist.zip を実際に利用する [Akashic System][sys] の [紹介][sys-intro] も併せて参照してください。
>
> [dists]: https://github.com/akashic-games/akashic-runtime-distributables
> [dists-rel]: https://github.com/akashic-games/akashic-runtime-distributables/releases
> [sys-intro]: https://akashic-games.github.io/akashic-system/
...
設定値は、適切な通信路を提供するサーバから受け取ったものを与えてください。
(e.g. [Akashic System][sys] の [プレートークン API][token-api] で発行されたトークンなど)
...
[sys]: https://github.com/akashic-games/akashic-system
[token-api]: https://github.com/akashic-games/akashic-system/blob/main/docs/system-api-doc/reference/plays_tokens.md
